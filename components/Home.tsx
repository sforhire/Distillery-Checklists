    ...
    <div className="space-y-10">
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          >
            <div className="bg-slate-800 group-hover:bg-amber-600 transition-colors rounded-xl p-4">
      ...
      <section>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          >
            <div className="bg-slate-800 group-hover:bg-slate-700 transition-colors rounded-xl p-3">
          ...
          >
            ...
            <ChevronRightIcon className="w-5 h-5 text-slate-600 group-hover:text-amber-500" />
          </button>
        </div>
      </section>
    </div>
...
const SunIcon = ({ className }: { className?: string }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364-6.364l-.707.707M6.343 17.657l-.707.707m12.728 0l-.707-.707M6.343 6.343l-.707-.707M12 8a4 4 0 100 8 4 4 0 000-8z" /></svg>
);
